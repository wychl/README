...
var (
	...
	// 交换机名字
	exchangeName = flag.String("exchange", "MyComment", "Durable AMQP exchange name")
	// 交换机类型 direct topic fanout
	exchangeType = flag.String("exchange-type", "direct", "Exchange type - direct|fanout|topic|x-custom")
	// 路由key
	routingKey = flag.String("key", "Comment_key", "AMQP routing key")
	// 发送的主体
	body = flag.String("body", "测试哈哈", "Body of message")
	// 是否可靠
